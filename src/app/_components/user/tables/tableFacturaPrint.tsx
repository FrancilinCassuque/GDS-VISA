    ...
    <>
      ...
      <Card x-chunk="dashboard-05-chunk-3" className={printOnly ? "sr-only" : ''} >
        <CardHeader className="px-7">
          ...
          <CardTitle>Total de factura</CardTitle>
          <CardDescription>factura Registrados Recentimente.</CardDescription>
        </CardHeader>
                ...
                <TableRow>
                  <TableCell colSpan={4} className="border-none">
                    <div className='flex flex-col items-center my-10 justify-center'>
                      ...
                      <CardTitle>GOTA D' SOL - factura</CardTitle>

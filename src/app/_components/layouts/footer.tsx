  ...
  return (
    <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
      ...
      <nav className="sm:ml-auto flex gap-4 sm:gap-6">
        <Link href="/terms-and-privacy/terms" className="text-xs hover:underline underline-offset-4" prefetch={false}>
          Termos de Serviço
        </Link>
        <Link href="/terms-and-privacy/privacy" className="text-xs hover:underline underline-offset-4" prefetch={false}>
          Privacidade
        </Link>
